...
sign-efi-sig-list: sign-efi-sig-list.o lib/openssl_sign.o
...
sigtest: sign-efi-sig-list
	./sign-efi-sig-list -g a25e0ad4-9c64-11f0-8e7e-0800279b31a2 -t "2025-03-24 14:26:01" -k KEK.key -c KEK.crt db fedora.esl fedora.auth
